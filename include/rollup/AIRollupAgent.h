...
public:
    ...
    virtual void analyzeRollupMetrics(const RollupPerformanceMetrics& metrics) = 0;
...
public:
    explicit RLRollupAgent(std::shared_ptr<QZKPGenerator> zkp_generator);
    
    void analyzeRollupMetrics(const RollupPerformanceMetrics& metrics) override;
